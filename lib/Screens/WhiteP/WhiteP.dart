...
import 'package:iCOOK/Screens/WhiteP/whitep_scan.dart';
...
class WhiteP extends StatefulWidget {
  @override
  _WhitePState createState() => _WhitePState();
}

class _WhitePState extends State<WhiteP> {
  int i = 0;
  bool fish = true;
  bool apple = true;
  bool orange = true;
