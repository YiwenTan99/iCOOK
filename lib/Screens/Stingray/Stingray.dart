...
import 'package:iCOOK/Screens/Stingray/stingray_scan.dart';
...
class Stingray extends StatefulWidget {
  @override
  _StingrayState createState() => _StingrayState();
}

class _StingrayState extends State<Stingray> {
  int i = 0;
  bool fish = true;
  bool apple = true;
  bool orange = true;
