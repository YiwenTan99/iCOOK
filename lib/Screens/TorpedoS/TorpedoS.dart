...
import 'package:iCOOK/Screens/TorpedoS/torpedos_scan.dart';
...
class TorpedoS extends StatefulWidget {
  @override
  _TorpedoSState createState() => _TorpedoSState();
}

class _TorpedoSState extends State<TorpedoS> {
  int i = 0;
  bool fish = true;
  bool apple = true;
  bool orange = true;
